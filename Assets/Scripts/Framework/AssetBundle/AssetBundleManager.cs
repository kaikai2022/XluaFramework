...
namespace AssetBundles
{
    ...
    public partial class AssetBundleManager : MonoSingleton<AssetBundleManager>
    {
        ...
        public void AddAssetbundleAssetsCache(string assetbundleName, Type assetType, bool isAtlas,
            string postfix = null)
        {
#if UNITY_EDITOR
            if (AssetBundleConfig.IsEditorMode)
    ...
    public partial class AssetBundleManager
    {
        ...
        public BaseAssetBundleAsyncLoader LoadAssetBundleAsync(string assetbundleName, Type type = null,
            bool isatlas = false)
        {
#if UNITY_EDITOR
            if (AssetBundleConfig.IsEditorMode)
        ...
        public BaseAssetRequester RequestAssetBundleAsync(string assetbundleName)
        {
            // var creater = AssetBundleRequester.Get();
            // var url = AssetBundleUtility.GetAssetBundleDataPath(assetbundleName);
            var creater = WebAssetRequester.Get();
