...
public class ProtoBufSerializer_Test : Singleton<ProtoBufSerializer_Test>
{
    ...
    {
        ProtoBufSerializer_Test.Instance.model.Serialize(dest, instance);
    }

    static public object Deserialize(Stream source, System.Type type, int length = -1)
    {
        return ProtoBufSerializer_Test.Instance.model.Deserialize(source, null, type, length, null);
    }
