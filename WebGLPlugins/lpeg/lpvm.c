...
static const InstructionLpeg giveup = {{IGiveup, 0, 0}};
...
typedef struct Stack {
  ...
  const InstructionLpeg *p;  /* next instruction */
  int caplevel;
} Stack;
...
const char *match (lua_State *L, const char *o, const char *s, const char *e,
                   InstructionLpeg *op, Capture *capture, int ptop) {
  ...
  const InstructionLpeg *p = op;  /* current instruction */
